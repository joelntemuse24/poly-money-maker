...
class BotWiresCurrentRails(unittest.TestCase):
    def test_5m_uses_slug_clock_and_dump_helpers(self):
        ...
        self.assertIn('"hedge_late_ttm_s": 0.0', src)
        self.assertIn('"hedge_dump_persist_s": 2.0', src)
        self.assertIn("dump_persist_s=HEDGE_DUMP_PERSIST_S", src)
        self.assertIn("_hedge_dump_armed", src)
        ...
        self.assertIn('"late_90_start_s": 0', src)
