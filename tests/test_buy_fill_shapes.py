...
class BalanceAndGcSemantics(unittest.TestCase):
    ...
    def test_examples_are_disarmed(self):
        ...
        self.assertEqual(five["hedge_late_ignore_oracle"], True)
        self.assertEqual(five["hedge_oracle_ignore_ttm_s"], 60.0)
        self.assertEqual(five["hedge_oracle_against_dump"], 0.50)
