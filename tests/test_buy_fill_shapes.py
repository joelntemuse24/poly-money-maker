...
class AmbiguousCrossCyclePolicy(unittest.TestCase):
    ...
    def test_toxic_recovered_and_market_cycle_isolation(self):
        ...
        self.assertIn("hedge_skip_winner_rest", five)
        ...
        self.assertIn('"hedge_winner_rest_ttl_s": 2.0', five)
        self.assertIn('"hedge_winner_rest_cushion": 0.10', five)
...
class BalanceAndGcSemantics(unittest.TestCase):
    ...
    def test_examples_are_disarmed(self):
        ...
        self.assertEqual(five["hedge_winner_rest_ttl_s"], 2.0)
        self.assertEqual(five["hedge_winner_rest_cushion"], 0.10)
