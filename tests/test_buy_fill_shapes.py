...
class AmbiguousCrossCyclePolicy(unittest.TestCase):
    ...
    def test_toxic_recovered_and_market_cycle_isolation(self):
        ...
        self.assertIn('"hedge_toxic_bid_max": 0.32', hourly)
        ...
        self.assertIn('"hedge_dump_ignore_oracle": True', hourly)
        self.assertIn("hedge_dump_overrides_oracle(", hourly)
        self.assertIn("hold_while_oracle_agrees(", hourly)
        self.assertIn("hedge_skip_oracle_still_winning", hourly)
        self.assertIn("dump_only_override", hourly)
        self.assertIn("dump_oracle_override", hourly)
...
class BalanceAndGcSemantics(unittest.TestCase):
    ...
    def test_examples_are_disarmed(self):
        ...
        self.assertEqual(hourly["hedge_toxic_bid_max"], 0.32)
        ...
        self.assertEqual(hourly["hedge_dump_ignore_oracle"], True)
