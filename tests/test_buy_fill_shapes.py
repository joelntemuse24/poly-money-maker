...
class AmbiguousCrossCyclePolicy(unittest.TestCase):
    ...
    def test_toxic_recovered_and_market_cycle_isolation(self):
        ...
        self.assertIn('"hedge_persist_s": 1.0', five)
        self.assertIn('"hedge_toxic_bid_max": 0.40', five)
        self.assertIn('"hedge_flatten_walks": True', five)
        self.assertIn('"toxic_force_exit_below": 0.75', five)
        self.assertIn("hedge_ladder_for_ttm(", five)
        self.assertIn('"hedge_late_ttm_s": 0.0', five)
        self.assertIn('"hedge_dump_persist_s": 2.0', five)
        self.assertIn("dump_persist_s=HEDGE_DUMP_PERSIST_S", five)
        self.assertIn("hedge_flatten_overrides_oracle(", five)
        self.assertIn("flatten=flatten_armed", five)
        self.assertIn("flatten_walk", five)
        ...
        self.assertNotIn("hedge_flatten_walks", hourly)
        self.assertNotIn("hedge_flatten_overrides_oracle", hourly)
...
class BalanceAndGcSemantics(unittest.TestCase):
    ...
    def test_examples_are_disarmed(self):
        ...
        self.assertEqual(five["buy_start_s"], 60)
        self.assertEqual(five["early_buy_start_s"], 60)
        ...
        self.assertEqual(five["early_95_min_price"], 0.97)
        self.assertEqual(five["late_90_start_s"], 0)
        self.assertEqual(five["min_underlying_edge_usd"], 0.0)
        self.assertEqual(five["hedge_threshold"], 0.50)
        self.assertEqual(five["hedge_require_ask_max"], 0.52)
        self.assertEqual(five["hedge_persist_s"], 1.0)
        self.assertEqual(five["hedge_toxic_bid_max"], 0.40)
        self.assertEqual(five["hedge_min_price"], 0.40)
        self.assertEqual(five["toxic_force_exit_below"], 0.75)
        self.assertIs(five["hedge_flatten_walks"], True)
        self.assertEqual(five["hedge_recovery_cancel"], 0.53)
        self.assertEqual(five["hedge_late_ttm_s"], 0.0)
        self.assertEqual(five["hedge_dump_persist_s"], 2.0)
        ...
        self.assertEqual(five["buy_threshold"], 0.90)
        self.assertEqual(five["buy_max_price"], 0.96)
        self.assertLess(five["buy_max_price"], five["early_95_min_price"])
        self.assertEqual(five["buy_budget"], 10.0)
        self.assertEqual(five["late_buy_budget"], 10.0)
        self.assertEqual(five["buy_max_spend"], 11.0)
        self.assertEqual(five["buy_max_shares"], 17.0)
        ...
        self.assertEqual(fifteen["buy_window_min"], 3.0)
        self.assertEqual(fifteen["buy_budget"], 10.0)
        self.assertEqual(fifteen["buy_max_spend"], 11.0)
        self.assertEqual(fifteen["buy_max_shares"], 17.0)
    ...
    def test_docs_live_overlay_is_92c_10_last60(self):
        ...
        self.assertIn('"buy_start_s": 60', current)
        self.assertIn('"buy_max_price": 0.96', current)
        self.assertIn('"early_95_min_price": 0.97', current)
        ...
        self.assertIn("last **60s**", ttd)
        self.assertIn("90–96", ttd)
