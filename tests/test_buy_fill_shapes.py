...
class BalanceAndGcSemantics(unittest.TestCase):
    ...
    def test_examples_are_disarmed(self):
        ...
        self.assertEqual(five["early_buy_start_s"], 120)
        ...
        self.assertGreater(five["early_95_min_price"], five["buy_max_price"])
        ...
        self.assertEqual(five["buy_max_spend"], 3.0)
        self.assertEqual(five["buy_max_shares"], 5.0)
        ...
        self.assertEqual(hourly["a22_window_min"], 10.0)
        self.assertEqual(hourly["b15_window_min"], 20.0)
        self.assertIs(hourly["early_rich_a22_enabled"], True)
        self.assertEqual(hourly["early_rich_a22_ask_min"], 0.97)
        self.assertEqual(hourly["early_rich_a22_persist_s"], 90.0)
        self.assertEqual(hourly["early_rich_a22_window_min"], 20.0)
