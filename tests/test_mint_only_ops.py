...
class MintDefaultsTests(unittest.TestCase):
    def test_example_and_defaults_are_15m_only(self):
        ...
        for blob, label in ((example, "example"), (defaults, "defaults")):
            self.assertEqual(blob["sell_threshold"], 0.05, label)
            ...
            self.assertEqual(blob["sell_dump_if_sister_miss_s"], 10.0, label)
...
class DeployUnitsTests(unittest.TestCase):
    ...
    def test_concurrent_loops_do_not_skip_mint_or_change_persist(self):
        ...
        self.assertEqual(defaults["sell_threshold"], 0.05)
        ...
        self.assertEqual(example["sell_threshold"], 0.05)
        ...
        self.assertEqual(defaults["sell_dump_if_sister_miss_s"], 10.0)
        self.assertEqual(example["sell_dump_if_sister_miss_s"], 10.0)
        self.assertIn("sell_dump_sister_miss", src)
        self.assertIn("positions_scrapbid.json", src)
        self.assertIn("sister_hedge_dump_due", src)
        self.assertEqual(defaults["sell_late_window_s"], 120.0)
        self.assertEqual(example["sell_late_window_s"], 120.0)
        self.assertEqual(defaults["sell_oracle_edge_per_ttm"], 1.5)
        self.assertEqual(defaults["sell_oracle_edge_persist_s"], 3.0)
        self.assertEqual(defaults["sell_oracle_stale_s"], 5.0)
        self.assertEqual(defaults["sell_oracle_edge_floor_usd"], 25.0)
