...
def buy_market_with_retry(token_id, size, max_price, tick_size="0.001", max_retries=3):
...
while not _shutdown_requested:
    try:
        ...
        for m in markets:
            ...
            # --- HEDGE CHECK (for held positions — fires whenever bid drops) ---
